...
class AmazonDropshippingJobs extends StatefulWidget {
  const AmazonDropshippingJobs({Key? key});

  @override
  // ignore: library_private_types_in_public_api
  _AmazonDropshippingJobsState createState() => _AmazonDropshippingJobsState();
}

class _AmazonDropshippingJobsState extends State<AmazonDropshippingJobs> {
...
//   NotificationServices notificationServices = NotificationServices();
  ...
  final String rssFeedUrl =
      'https://www.upwork.com/ab/feed/jobs/rss?q=Amazon+Drop+shipping&sort=recency&paging=0%3B50&api_params=1&securityToken=16ee94fbc170be3746e4c2f537fe0dd26609cd1375b38ed654f7abbc3bdd037b3d2e8dcc7d24c01bcc95628fea6c237a9b6c8d356e4c0ac652892b5037279bcd&userUid=1556630119112642560&orgUid=1556630119112642561';
        ...
        body: FutureBuilder<List<Map<String, String>>?>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Container(
                color: const Color.fromARGB(60, 39, 157, 207),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Selectable(
                      child: Card(
                        ...
                        child: ExpansionTile(
                          backgroundColor:
                              const Color.fromARGB(43, 86, 197, 222),
                          title: Text(
                            jobDetails?['Title'] ?? '',
                            style: GoogleFonts.poppins(
                              fontSize: 18,
